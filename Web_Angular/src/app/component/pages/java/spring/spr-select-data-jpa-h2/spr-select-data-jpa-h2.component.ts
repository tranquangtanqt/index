...
export const TABLE_OF_CONTENT : ITableOfContent [] = [
  {
    ...
    id: 11,
    title: "ConnectH2DatabaseApplication.java",
    gotoElement: "goto11",
  },{
    id: 12,
...
spring.jpa.database-platform=org.hibernate.dialect.H2Dialect`,
	code_3: `CREATE TABLE IF NOT EXISTS TBL_BOOK(
...
INSERT INTO TBL_BOOK (id, title, isbn, publisher) VALUES
  ...
  (3, 'title_3', 'isbn_3', 'publisher_3');`,
	code_4: `package com.learning.connect.h2.database.entity;
...
public class Book implements Serializable {
	...
	code_5: `package com.learning.connect.h2.database.dto;
...
public class ApiResponse<T> extends ResponseEntity {
	...
	code_6: `package com.learning.connect.h2.database.dto;
...
public class BookDto implements Serializable{
	...
	code_7: `package com.learning.connect.h2.database.repository;
...
public interface IBookRepository extends JpaRepository<Book, Long>{
	...
	code_8: `package com.learning.connect.h2.database.services;
...
public class BookService {
	...
	code_9: `package com.learning.connect.h2.database.controller;
...
public class BookController {
	...
	code_10: `package com.learning.connect.h2.database;
